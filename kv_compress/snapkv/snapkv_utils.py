...
class SnapKVCluster():
    ...
    def update_kv(self, key_states, query_states, value_states):
        ...
        if q_len < self.max_capacity_prompt:
            ...
            self.save_scores = attn_cache.topk(self.max_capacity_prompt - self.window_size, dim=-1).values
...
def init_snapkv(self):
    # In section 5.3 of the paper, Experiments on LongBench. " We use max pooling with kernel size 7 and observation window size 32. "
